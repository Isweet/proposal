...
\mwh{Your prior chapter gave us an idea of what this was about. Can you
  suggest that readers could skip over these formal details if they
  like? What are critical things they need to know from this chapter?
  I don't think anyone will be remiss if they skip all of the
  formalization and instead cut to the chase: You have a formalized
  language, which you implemented, and which you have a proved
  property for. Also: Make clear what parts here you are claiming for your thesis,
  and what is just background (recall my earlier comment about ``prior
  work'' vs. ``already completed work'')} \ins{Look good?}
...
by the~\nameref{thm:mpc-simulation} theorem, and \textbf{(2)} that there is empirical evidence suggesting that
...
on the Haskell implementation, \system.~\Cref{sec:mpc-theory} describes \mpc formally, defining the syntax,
