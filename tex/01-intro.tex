...
\mwh{You should be including Symphony as part of your contribution. You had a big part to play in this work. It will be in no one else's thesis but yours. You are going to make a static type system for it, so that's also part of your thesis and should be here.}
...
\paragraph{Contribution: \obliv is PMTO.} In prior work \mwh{This prior work is work that will be part of your thesis. So call it ``initial work'' or ``already completed work'' so we are clear that you including this as your contribution, which we are assessing}, we show that ObliVM's~\cite{todo} type system is not oblivious,
