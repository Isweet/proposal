...
\vspace*{-2ex}
  \caption{%
    ...
    who is wealthiest.
    Each competition winner is revealed, but each party's wealth is kept secret.
    %\dcd{what does “she gets a bye” mean in the comment for
      %\lstinline|round|?} \mwh{No competition}
