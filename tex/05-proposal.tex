...
% Given a relation ⸨a R m b⸩ where ⸨m⸩ is a monad, we can define the monadic lifting
% of the relation, ⸨m a mR m b⸩, as follows.
...
\ins{A: The proof is at least complicated by the fact that the sequential semantics is no-longer deterministic.} \\
